// src/components/forms/TreatmentForm.tsx
...
const TreatmentForm: React.FC<TreatmentFormProps> = ({ isOpen, onClose }) => {
  const { createTratamento } = useTreatment();
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose}>
      <ModalOverlay />
      <ModalContent>
        <ModalHeader backgroundColor={"#3182ce"} color={"#FFFFFF"}>Cadastrar Tratamento</ModalHeader>
